...
exports.prepareCart = exports.cartGetRouter = void 0;
...
exports.cartGetRouter = router;
router.get("/cart/get", [(0, express_validator_1.query)("id").notEmpty().isString().withMessage("ID is required")], core_1.currentUser, core_1.requireAuth, core_1.validateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield shared_1.Cart.findOne({ _id: req.query.id });
    if (cart) {
...
const prepareCart = (cart) => __awaiter(void 0, void 0, void 0, function* () {
    const promises = _.map(cart.products, (product, i) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        yield inventory_1.Inventory.findOne({});
    ...
    const merchant = yield customer_1.Customer.findById(cart.merchantId);
    const supplier = yield customer_1.Customer.findById(cart.supplierId);
    return {
        id: cart.id,
        status: cart.status,
        userId: cart.userId,
