...
exports.ColaStatusLogCacheListener = void 0;
...
class ColaStatusLogCacheListener extends core_1.Listener {
    constructor() {
        super(...arguments);
        this.subject = cola_integration_1.ColaOrderStatusSubjects.OrderStatusRecieved;
        this.queueGroupName = "new-cola-status-service";
    }
    onMessage(data, msg) {
...
exports.ColaStatusLogCacheListener = ColaStatusLogCacheListener;
